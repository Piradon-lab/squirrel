...
?>
        <tr>
            ...
            <td><?php echo $Result['Action'];?><a href = "edit_form.php?edit_id=<?php echo $Result['ID']; ?>"><button type="button" class="btn btn-primary">Edit</button>   <a href = "remove.php?delete_id=<?php echo $Result['ID']; ?>"><button type="button" class="btn btn-primary">Delete</button></td>        
        </tr>
        <?php
}
?>
